...
/**
 * DBManager class : This class provides an easy to use interface for managing
 * databases It behaves mostly as a wrapper for the jdbc library (Make it easier
 * to query databases)
 * 
...
public class DBManager {
	...
	/**
	 * Constructor for the DB manager => initialize connection to the DB WARNING :
	 * this constructor may fail ! => ensure that the object is valid after it's
	 * creation if you want an extra safety
	 */
	public DBManager() {
	...
	public List<HashMap<String,Object>> convertToList(ResultSet rs) throws SQLException {
	...
	public static void main(String[] args) {
		try {
			...
			// SQLQuery s = new
			// SQLQuery(".\\Resources\\SQLQueries\\SelectUpdateLog.sql",true);
			...
			// db.printQueryResult(db.ExecuteSQLQuery(s, LocalDateTime.of(2019, 07, 11, 10,
			// 0) ));
